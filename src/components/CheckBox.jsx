                ...
                <div className="relative">
                    <input
                        ...
                        className={`
                            ...
                            ${checked
                                ? 'bg-[#2469F6] border-[#2469F6] hover:bg-[#5087F8] hover:border-[#5087F8]'
                                : 'border-[#CDCDCD] hover:border-[#BDBDBD] hover:bg-white'
                            }
                            ${isPressed && checked ? 'ring-2 ring-blue-200 bg-[#2469F6] border-[#2469F6]' : ''}
                    ...
                    {checked && (
                        <svg width="19" height="14" viewBox="0 0 19 14" fill="none" xmlns="http://www.w3.org/2000/svg" className="absolute top-[40%] left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-white pointer-events-none">
                            <path d="M1 7.6L7.03451 12.9672C7.05497 12.9854 7.08626 12.9837 7.1047 12.9635L18 1" stroke="white" strokeLinecap="round" />
                        </svg>
                    )}
                    {!checked && isHovered && (
                        <svg
